...
| [Git-backed Artifact Ledger & Sync](candidates/git-backed-artifact-sync.md) | Promoted | Formed as `.streamliner/workstreams/git-backed-artifact-sync/`: `artifact-root-v1`, convention-first artifact-branch bootstrap, deterministic sync, policy provenance, and the campaign integration gate. |
