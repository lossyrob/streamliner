...
Work Title: Graph Node Session Status
Work ID: graph-node-session-status-indicators
Workflow Identity: paw-lite
Base Branch: main
Target Branch: feature/graph-node-session-status-indicators
Execution Mode: worktree
Repository Identity: github.com/lossyrob/streamliner@154ce519f66916dfe71f62c49f49f4de6a65a3f7
Execution Binding: worktree:graph-node-session-status-indicators:feature/graph-node-session-status-indicators
...
Initial Prompt: none
Issue URL: https://github.com/lossyrob/streamliner/issues/50
Remote: origin
Artifact Lifecycle: commit-and-clean
Artifact Paths: auto-derived
Additional Inputs: streamliner-context=C:\Users\robemanuele\proj\streamliner\streamliner-graph-node-session-status-indicators\.paw\work\graph-node-session-status-indicators\streamliner\context.md
