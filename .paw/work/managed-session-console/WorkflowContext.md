...
Work Title: Managed Session Console
Work ID: managed-session-console
Base Branch: main
Target Branch: feature/managed-session-console
Execution Mode: worktree
Repository Identity: github.com/lossyrob/streamliner@154ce519f66916dfe71f62c49f49f4de6a65a3f7
Execution Binding: worktree:managed-session-console:feature/managed-session-console
Workflow Mode: full
...
Initial Prompt: none
Issue URL: https://github.com/lossyrob/streamliner/issues/85
Remote: origin
