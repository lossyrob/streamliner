...
import { prepareLaunchContextPackage } from "./launch-context";
...
describe("prepareLaunchContextPackage", () => {
  it("writes one worker-facing context file and returns system metadata", async () => {
    ...
    expect(context).toContain("## Layer 1 - Workstream Intent");
    expect(context).toContain("## Layer 2 - Operational State");
    expect(context).toContain("## Layer 3 - Node Context");
